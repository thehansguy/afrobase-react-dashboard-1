...
export default function TypographyPage() {
  ...
  return (
    <>
      <PageTitle title="Economic Policy" />
      <Grid container spacing={4}>
        <Grid item xs={12} md={6}>
          <Widget title="Policy 1" disableWidgetMenu>
        ...
        <Grid item xs={12} md={6}>
          <Widget title="Policy 2" disableWidgetMenu>
            <div className={classes.dashedBorder}>
        ...
        <Grid item xs={12} md={6}>
          <Widget title="Policy 3" disableWidgetMenu>
            <div className={classes.dashedBorder}>
        ...
        <Grid item xs={12} md={6}>
          <Widget title="Policy 4" disableWidgetMenu>
            <div className={classes.dashedBorder}>
